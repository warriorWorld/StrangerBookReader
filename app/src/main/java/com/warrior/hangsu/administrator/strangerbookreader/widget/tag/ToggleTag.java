package com.warrior.hangsu.administrator.strangerbookreader.widget.tag;
...
public class ToggleTag extends LinearLayout {
    ...
    private void toggleSelect() {
        if (isChecked) {
            ...
            tagTv.setTextColor(context.getResources().getColor(R.color.english_book_reader));
    ...
    public void setItem(ClassifyListBean item) {
        this.item = item;
        setTagTvText(item.getTag());
    }
}
