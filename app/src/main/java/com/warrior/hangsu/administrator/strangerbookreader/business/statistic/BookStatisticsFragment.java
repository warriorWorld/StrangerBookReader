...
//import com.warrior.hangsu.administrator.strangerbookreader.bean.BookStatisticsBean;
...
// * 个人信息页
// */
//public class BookStatisticsFragment extends BaseStatisticsFragment implements View.OnClickListener {
//    private ArrayList<BookStatisticsBean> handled_list = new ArrayList<>();
...
//     * @return
//     */
//    private ArrayList<BookStatisticsBean> handleBookList(ArrayList<CalendarStatisticsBean> list) {
...
//
//
//        ArrayList<BookStatisticsBean> finalRes = new ArrayList<>();//总体统计数据
