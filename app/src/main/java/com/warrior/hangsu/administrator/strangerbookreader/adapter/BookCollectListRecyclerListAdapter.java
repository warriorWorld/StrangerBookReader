 ...
 */
public class BookCollectListRecyclerListAdapter extends BaseRecyclerAdapter {
    ...
    public BookCollectListRecyclerListAdapter(Context context) {
        super(context);
    }
    ...
    protected RecyclerView.ViewHolder getNormalViewHolder(ViewGroup viewGroup) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_book_collect, viewGroup, false);
    ...
    protected void refreshNormalViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        ((NormalViewHolder) viewHolder).book_spider_tv.setText(item.getSpider());
    ...
    public static class NormalViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView book_title_tv, book_spider_tv;
        ...
        public NormalViewHolder(View view) {
            ...
            book_spider_tv = (TextView) view
                    .findViewById(R.id.book_spider_tv);
        }
    }
