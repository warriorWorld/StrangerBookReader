...
public class TranslateResultDialog extends Dialog implements View.OnClickListener {
    ...
    private OnFreeTTSListener mOnFreeTTSListener;
    private String word;
    ...
    public void setTranslate(Translate translate) {
        ...
        if (null != translate && null != translate.getExplains() && translate.getExplains().size() > 0) {
            if (SharedPreferencesUtils.getBooleanSharedPreferencesData
                    (context, ShareKeys.OPEN_PREMIUM_KEY, false)) {
                playVoice(translate.getSpeakUrl());
            } else {
                if (null != mOnFreeTTSListener) {
                    mOnFreeTTSListener.onTTS(translate.getQuery());
                }
            }
...
//                ukPhoneticTv.setText("");
    ...
    public void setOnFreeTTSListener(OnFreeTTSListener onFreeTTSListener) {
        mOnFreeTTSListener = onFreeTTSListener;
    }
}
